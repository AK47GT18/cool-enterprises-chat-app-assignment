    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Join Cool Enterprises Chat</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between p-4 bg-[#0f172a]/30 rounded-2xl border border-[#334155]">
            <div className="flex items-center gap-3">
              {isPublic ? (
                <Shield className="text-blue-400 w-5 h-5" />
              ) : (
                <ShieldOff className="text-slate-500 w-5 h-5" />
              )}
              <div>
                <p className="text-sm font-medium text-white">Public Profile</p>
                <p className="text-xs text-slate-500">{isPublic ? 'Visible to everyone' : 'Only friends can see'}</p>
              </div>
            </div>
            <button
              type="button"
